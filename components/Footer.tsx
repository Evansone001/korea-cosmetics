    ...
    const linkSections: FooterSection[] = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Skincare", path: '/shop', icon: null },
                { text: "Makeup", path: '/shop', icon: null },
                { text: "Hair Care", path: '/shop', icon: null },
                { text: "Body Care", path: '/shop', icon: null },
            ]
        },
        {
            title: "WEBSITE",
            links: [
                ...
                { text: "B2B Wholesale", path: '/wholesale', icon: null },
                { text: "Manufacturers", path: '/manufacturers', icon: null },
            ]
        },
        {
            title: "CONTACT",
