            ...
            {order.orderItems.map((item, index) => (
              <div key={index} className="flex items-center gap-4">
                ...
                <div className="flex flex-col justify-center text-sm">
                  ...
                  <div>
                    {ratings.find((rating: any) => order.id === rating.orderId && item.product.id === rating.productId)
                      ? <Rating value={ratings.find((rating: any) => order.id === rating.orderId && item.product.id === rating.productId).rating} />
